...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        ...
                        <font color="#fff"> เพิ่มผู้เล่น </font>
                        </button>
                    </li>
                </ul>
    ...
    <div class="container">
        <div class="row justify-content-start align-items-start g-2">
            <div class="col">
                <h5 class="display-5"> <font color="#fff"> รายการนักฟุตบอล </font> </h5>
            </div>
           ...
           ?>
                <div class="col-3 col-md-6 col-xl-3 ">
                    <div class="card" style="width: 18rem;">
                        <img src="../public/images/<?php echo ($result[$i]->image_url) ?>" class="card-img-top" width="250" height="250 " alt="...">
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php echo ($result[$i]->firstname . " " . $result[$i]->lastname) ?>
                            </h5>
                            <p class="card-title"><b>Team :</b> <?php echo ($result[$i]->team) ?></p>
                            <p class="card-title"><b>Position :</b> <?php echo ($result[$i]->position) ?></p>
