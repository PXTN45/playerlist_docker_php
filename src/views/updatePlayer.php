    ...
    <div id="forminput">
        <div class="container-fluid">
            <div class="row justify-content-center align-items-center g-2">
                    <div class="col-5 bg-dark" style="padding:20px; border-radius: 5%;">
                        <form action="../index.php?playerRout=update" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <center>
                                    <h1><font color="#fff"> แก้ไขข้อมูลนักฟุตบอล </font></h1>
                                </center>
                                <div class="mb-3">
                                ...
                                <div>
                                    <img src="../public/images/<?php echo ($player->image_url) ?>" 
